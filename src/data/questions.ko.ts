...
export const questionsKo: Question[] = [
  {
    id: "q1",
    category: "session",
    scenario:
      "Claude Code와 긴 대화를 나누다 보니 컨텍스트가 커져서 응답이 느려졌다. 현재 작업 맥락은 계속 필요하다. 어떻게 하겠는가?",
    options: [
      {
        text: "그냥 계속 대화를 이어간다",
        score: 0,
      ...
      {
        text: "현재 작업 맥락을 유지해야 하므로 /compact로 대화를 요약한다",
        score: 3,
        tokenImpact: 3,
        logMessage:
      ...
      {
        text: "지금 맥락이 불필요하고 새 작업이라면 /clear로 완전히 초기화한다",
        score: 2,
        tokenImpact: 2,
        logMessage:
    ...
    insight:
      "기준은 단순합니다. 같은 작업을 이어가면 /compact, 완전히 다른 작업으로 전환하면 /clear가 적절합니다. 대화가 길어질수록 /compact를 주기적으로 사용하세요.",
  },
  {
    id: "q2",
    category: "prompt",
